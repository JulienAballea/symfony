 ...
 */
final class Version20220422122400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE trajet (id INT AUTO_INCREMENT NOT NULL, ville_dep_id INT DEFAULT NULL, ville_arr_id INT DEFAULT NULL, nb_kms INT NOT NULL, datetrajet DATETIME NOT NULL, UNIQUE INDEX UNIQ_2B5BA98C97A9E2C6 (ville_dep_id), UNIQUE INDEX UNIQ_2B5BA98CBFADF06C (ville_arr_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE voiture (id INT AUTO_INCREMENT NOT NULL, marque_id INT DEFAULT NULL, nb_places INT NOT NULL, modele VARCHAR(255) NOT NULL, INDEX IDX_E9E2810F4827B9B2 (marque_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
